...
|---|---|---|
| Agent display name | `HVA Prince Court Test - English` | DECIDED |
...
| Test-call cost owner/budget | Project developer; `MYR 0` until a separate paid-test budget is recorded | DECIDED |
...
- [x] Test-call cost owner and zero-spend default recorded.
- [x] Synthetic dataset accepted for non-production learning use.
- [x] No secrets or real patient data committed in this document.

**Current exit-gate result: NOT PASSED.** The decision and policy baseline is complete for the learning-project scope. The gate remains open only because the separate Supabase project and isolated Retell resources/identifiers have not yet been provisioned.
